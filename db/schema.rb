...
ActiveRecord::Schema.define(version: 2021_09_30_173446) do
  ...
  create_table "onboarding_sessions", force: :cascade do |t|
    ...
    t.index ["platform_tenant_id"], name: "index_onboarding_sessions_on_platform_tenant_id"
  ...
  create_table "user_authentication_tokens", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["platform_tenant_id"], name: "index_user_authentication_tokens_on_platform_tenant_id"
